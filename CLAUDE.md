...
`.claude/skills/content-playbook/SKILL.md` is a companion skill for *ongoing* organic content and personal-brand/authority building (as opposed to a one-time launch) across X, YouTube, and short-form (Reels/TikTok) — niche/profile strategy, platform algorithm mechanics, YouTube SEO/retention, and short-form hook/retention/reward structure. X and YouTube tactics are Track A only; short-form craft applies to both tracks. It deliberately excludes the source article's account-farming section (residential proxies + fabricated US identity to spoof location for Instagram/TikTok) as platform-detection evasion, not a marketing technique. Invoke it for X/YouTube/Reels/TikTok growth and content-strategy requests; invoke `launch-video` for a one-time X launch push, `growth-playbook` for everything else GTM-related.
